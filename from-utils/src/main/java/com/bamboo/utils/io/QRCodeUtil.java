...
public class QRCodeUtil {
     ...
     * @throws Exception
     */
    public static ByteArrayOutputStream encodeOutputStream(String content, boolean needCompress) throws Exception {
        ByteArrayOutputStream outs = new ByteArrayOutputStream();
        BufferedImage image = QRCodeUtil.createImage(content, null, needCompress);
        ImageIO.write(image, FORMAT, outs);
        return outs;
    }
   ...
   /* public static void main(String[] args) throws Exception {
        String text = "http://app.fang-crm.com";
        //不含Logo
        QRCodeUtil.encode(text, null, "e:\\", true);
        //含Logo，不指定二维码图片名
        //QRCodeUtil.encode(text, "e:\\csdn.jpg", "e:\\", true);
        //含Logo，指定二维码图片名
//        QRCodeUtil.encode(text, "e:\\fjs.png", "e:\\", "qrcode", true);
    }*/
}