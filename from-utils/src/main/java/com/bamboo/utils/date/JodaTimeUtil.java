...
public class JodaTimeUtil {
	...
	public static void main(String[] args) {
		...
		System.err.println(getStartOfTheDay(date).getMillis());
		System.err.println(getStartOfTheDay(date));
		System.err.println(getEndOfTheDay(date));
		System.err.println(getEndOfTheDay(date).getMillis());
		System.err.println(getStartOfTheWeek(date));
		System.err.println(getEndOfTheWeek(date));
		System.err.println(getStartOfTheMonth(date));
		System.err.println(getEndOfTheMonth(date));
	}
